...
function CustomTooltip2({ payload, active }) {
  if (active) {
    return (
...
function Barchart({data}){
    ...
    return  ( 
        <React.Fragment>
        <div className="activityTitle">Activité quotidienne</div>
        <ResponsiveContainer  minWidth={745} width='100%' height={290}>
          <BarChart width='100%' data={data} margin={{top: 0,right: 0,left: 0,bottom: 0,}} barSize={7} barGap={8}>
